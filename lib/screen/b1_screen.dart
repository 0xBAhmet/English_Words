...
class B1WordsPage extends StatefulWidget {
  const B1WordsPage({super.key});

  @override
  State<B1WordsPage> createState() => _B1WordsPageState();
}

class _B1WordsPageState extends State<B1WordsPage> {
  var height, width;
  ...
  Future<void> loadWords() async {
    String data = await rootBundle.loadString('Data/b1_words.json');
    setState(() {
