...
class A1WordsPage extends StatefulWidget {
  const A1WordsPage({super.key});

  @override
  State<A1WordsPage> createState() => _A1WordsPageState();
}

class _A1WordsPageState extends State<A1WordsPage> {
  var height, width;
  ...
  Future<void> loadWords() async {
    String data = await rootBundle.loadString('Data/a1_words.json');
    setState(() {
