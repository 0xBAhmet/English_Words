...
class B2WordsPage extends StatefulWidget {
  const B2WordsPage({super.key});

  @override
  State<B2WordsPage> createState() => _B2WordsPageState();
}

class _B2WordsPageState extends State<B2WordsPage> {
  var height, width;
  ...
  Future<void> loadWords() async {
    String data = await rootBundle.loadString('Data/b2_words.json');
    setState(() {
